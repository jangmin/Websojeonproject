//(function () {
    ...
    var game = new Light.Game('game', 1100, 600, '#004A7B', function (asset) {
        ...
        asset.loadImage('bg','image/bg_1.png');
    ...
    introState.onInit = function () {
        this.addChild(new Light.Sprite(game.asset.getImage('bg')));
        this.children[0].height = 600;
        this.children[0].width = 1100;
    ...
    gameState.onInit = function () {
        ...
        this.addChild(new Light.Sprite(game.asset.getImage('bg')));
        this.children[0].height = 1200;
        this.children[0].width = 2000;
        ...
        //     for(let i=0;i<num-this.user.length;i++){
        //     console.log('userconnect');
        //     var user = new Player();
        //     user.x = 100;
        //     user.y = 400;
        //     this.user.push(user);
        //     this.unitLayer.addChild(user);}
        // });
    ...
    gameState.onUpdate = function (elapsed) {
        ...
        socket.emit('test',{x:this.player.x,y:this.player.y});
